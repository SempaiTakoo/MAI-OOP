...
TEST(MainFightTest, BigFighting) {
    ...
    array.insert(
        factory(ErrantKnightType, "TestKnight1", 30, 40, "test_fight.txt"));
    array.insert(
        factory(SquirrelType, "TestSquirrel1", 50, 60, "test_fight.txt"));

    array.insert(factory(SlaverType, "TestSlaver2", 15, 25, "test_fight.txt"));
    array.insert(
        factory(ErrantKnightType, "TestKnight2", 35, 45, "test_fight.txt"));
    array.insert(
        factory(SquirrelType, "TestSquirrel2", 55, 65, "test_fight.txt"));

    array.insert(factory(SlaverType, "TestSlaver3", 20, 30, "test_fight.txt"));
    array.insert(
        factory(ErrantKnightType, "TestKnight3", 40, 50, "test_fight.txt"));
    array.insert(
        factory(SquirrelType, "TestSquirrel3", 60, 70, "test_fight.txt"));
