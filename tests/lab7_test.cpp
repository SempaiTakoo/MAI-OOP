...
TEST(FightTest, SlaverVsErrantKnight) {
    ...
    auto errantKnight =
        factory(ErrantKnightType, "ErrantKnight", 1, 1, "test_fight.txt");
...
TEST(FightTest, ErrantKnightVsSquirrel) {
    auto errantKnight =
        factory(ErrantKnightType, "ErrantKnight", 0, 0, "test_fight.txt");
...
TEST(FightTest, LargeBattle) {
    ...
    npcs.insert(
        factory(ErrantKnightType, "ErrantKnight1", 2, 2, "test_fight.txt"));
    npcs.insert(
        factory(ErrantKnightType, "ErrantKnight2", 3, 3, "test_fight.txt"));
